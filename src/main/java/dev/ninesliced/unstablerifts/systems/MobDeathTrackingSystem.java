 ...
 * the cached UUID is forwarded to {@link dev.ninesliced.unstablerifts.dungeon.GameManager#onDungeonMobKilled}
...
public final class MobDeathTrackingSystem extends RefSystem<EntityStore> {
    ...
    public void onEntityRemove(@Nonnull Ref<EntityStore> ref,
        ...
        unstablerifts.getGameManager().getMobSpawningService().onDungeonMobKilled(uuid);
    }
}
