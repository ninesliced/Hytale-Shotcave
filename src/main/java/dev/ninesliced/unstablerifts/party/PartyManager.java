...
public final class PartyManager {
    ...
    public PartyManager(@Nonnull UnstableRifts plugin) {
        this.plugin = plugin;
    }
    ...
    public static Message partyPrefix() {
        return Message.raw("[UnstableRifts Party] ").color(new Color(202, 153, 76)).bold(true);
    }
    ...
    public synchronized ActionResult startParty(@Nonnull PlayerRef leaderRef) {
        ...
        broadcast(party, "Starting a fresh UnstableRifts dungeon instance...");
