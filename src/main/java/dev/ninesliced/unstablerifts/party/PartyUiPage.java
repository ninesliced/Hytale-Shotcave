...
public final class PartyUiPage extends InteractiveCustomUIPage<PartyUiPage.UiEventData> {
    ...
    public PartyUiPage(@Nonnull UnstableRifts plugin, @Nonnull PlayerRef playerRef) {
    ...
    public void build(@Nonnull Ref<EntityStore> ref,
        ...
        if (inParty) {
            ...
            boolean gameActive = game != null && game.getState() != dev.ninesliced.unstablerifts.dungeon.GameState.COMPLETE;
            ...
            if (gameActive) {
                String gameStatus = switch (game.getState()) {
                    ...
                    case ACTIVE ->
                            "Dungeon in progress — " + dev.ninesliced.unstablerifts.dungeon.Game.formatTime(game.getElapsedGameTime());
    ...
    public static final class UiEventData {
        ...
        static final BuilderCodec<UiEventData> CODEC = BuilderCodec.builder(UiEventData.class, UiEventData::new)
