...
public final class ContinuousBeamInteraction extends ChargingInteraction {
    ...
    private static final String CLIENT_CHARGE_CAP_INTERACTION_ID = "Shotcave_Update_Hud";
    ...
    static {
        ...
        builder.appendInherited(
                ...
                .addValidator((Validator<Double>) Validators.greaterThan(0.01d)).add();
        ...
        builder.appendInherited(
            ...
            .addValidator((Validator<Double>) Validators.greaterThanOrEqual(0.0d)).add();
        ...
        builder.appendInherited(
                ...
                .addValidator((Validator<Double>) Validators.greaterThan(0.05d)).add();
        ...
        builder.appendInherited(
                ...
                .addValidator((Validator<Double>) Validators.greaterThan(0.0d)).add();
    ...
    @Nullable
    private String beamParticleId = "Shotcave_ElectricBeam";
    ...
    protected void tick0(boolean firstRun, float time, @Nonnull InteractionType type,
        ...
        if (heldItem != null) {
            ...
            if (definition != null) {
                ...
                knockbackForce = definition.getBaseKnockback() * (1.0d + knockbackBonus);
            }
        }
    ...
    private static final class ShotHit {
        ...
        private ShotHit(@Nonnull Vector3d position,
