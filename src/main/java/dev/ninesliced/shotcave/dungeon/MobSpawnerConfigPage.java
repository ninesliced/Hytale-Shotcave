...
public final class MobSpawnerConfigPage extends InteractiveCustomUIPage<MobSpawnerConfigPage.SpawnerEventData> {
    ...
    private static final String LAYOUT_PATH = "Pages/Shotcave/MobSpawnerConfig.ui";
    private static final String LIST_PATH = "#MobListContainer";
    private static final String ENTRY_TEMPLATE = "Pages/Shotcave/MobSpawnerEntry.ui";
    ...
    public void build(@Nonnull Ref<EntityStore> ref,
        ...
        // Load existing data from block entity on first build
        if (!initialized) {
    ...
    private void buildEntryList(@Nonnull UICommandBuilder ui, @Nonnull UIEventBuilder events) {
        ...
        for (int i = 0; i < entries.size(); i++) {
            ...
            // Set TextField value and weight label
            ui.set(itemPath + " #MobIdInput.Value", entry.mobId);
            ui.set(itemPath + " #WeightLabel.Text", entry.weight);

            // Mob ID text input — ValueChanged fires on each keystroke
            events.addEventBinding(
    ...
    public void handleDataEvent(@Nonnull Ref<EntityStore> ref,
        ...
        // Handle TextField text changes (ValueChanged, no action)
    ...
    public static final class SpawnerEventData {
        ...
        static final BuilderCodec<SpawnerEventData> CODEC = BuilderCodec.<SpawnerEventData>builder(SpawnerEventData.class, SpawnerEventData::new)
        ...
        @Nullable private String mobInput;
    }
}
