 ...
 * death component, which is never added because Shotcave intercepts lethal damage. This system
 ...
 * entry for Shotcave's {@link DeathComponent} rather than matching by {@code Ref} identity,
...
public final class DeathAggroSuppressionSystem extends EntityTickingSystem<EntityStore> {
    ...
    /**
     * Returns {@code true} if the given ref belongs to a Shotcave-dead player.
